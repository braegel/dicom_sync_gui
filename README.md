...
|---|---|---|
| [`DICOM_Sync_1.3.2_macOS_arm64.dmg`](https://github.com/braegel/dicom_sync_gui/releases/download/v1.3.2/DICOM_Sync_1.3.2_macOS_arm64.dmg) | Apple Silicon (M1/M2/M3/M4) | ~59 MB |
| [`DICOM_Sync_1.3.2_macOS_x86_64.dmg`](https://github.com/braegel/dicom_sync_gui/releases/download/v1.3.2/DICOM_Sync_1.3.2_macOS_x86_64.dmg) | Intel | ~63 MB |
...
hdiutil create -volname "DICOM Sync 1.3.2" \
  -srcfolder _dmg -ov -format UDZO \
  releases/DICOM_Sync_1.3.2_macOS_${ARCH}.dmg
rm -rf _dmg
```
...
├── __init__.py                     # Package version (1.3.2)
